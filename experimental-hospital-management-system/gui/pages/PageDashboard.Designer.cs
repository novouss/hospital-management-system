...
namespace experimental_hospital_management_system.gui.pages
{
    partial class PageDashboard
    {
        ...
        {
            this.counterpanel = new experimental_hospital_management_system.gui.components.RoundedPanels();
            this.TableLayout = new System.Windows.Forms.TableLayoutPanel();
            this.billingcounter = new experimental_hospital_management_system.gui.components.CounterPanel();
            this.labcounter = new experimental_hospital_management_system.gui.components.CounterPanel();
            this.roomcounter = new experimental_hospital_management_system.gui.components.CounterPanel();
            this.patientcounter = new experimental_hospital_management_system.gui.components.CounterPanel();
            this.employeepanel = new experimental_hospital_management_system.gui.components.RoundedPanels();
            this.DisplayEmployeePreview = new experimental_hospital_management_system.gui.components.DisplayPreview();
            this.viewmoreemployees = new System.Windows.Forms.Label();
            this.employeelabel = new System.Windows.Forms.Label();
            this.greetingspanel = new experimental_hospital_management_system.gui.components.RoundedPanels();
            this.greetingslabel = new System.Windows.Forms.Label();
            this.schedulepanel = new experimental_hospital_management_system.gui.components.RoundedPanels();
            this.DisplayAppointmentPreview = new experimental_hospital_management_system.gui.components.DisplayPreview();
            this.viewmoreappointments = new System.Windows.Forms.Label();
            this.appointmentlabel = new System.Windows.Forms.Label();
            this.scheduledate = new experimental_hospital_management_system.gui.components.CustomDate();
        ...
        private experimental_hospital_management_system.gui.components.DisplayPreview DisplayEmployeePreview;
        private System.Windows.Forms.Label viewmoreemployees;
        private experimental_hospital_management_system.gui.components.DisplayPreview DisplayAppointmentPreview;
