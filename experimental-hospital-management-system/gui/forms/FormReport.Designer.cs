namespace experimental_hospital_management_system
{
    partial class FormReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.resultInfobox = new experimental_hospital_management_system.gui.components.InformationTextbox();
            this.labButtonbox = new experimental_hospital_management_system.gui.components.InformationButtonbox();
            this.employeeButtonbox = new experimental_hospital_management_system.gui.components.InformationButtonbox();
            this.departmentCombobox = new experimental_hospital_management_system.gui.components.InformationComboBox();
