namespace experimental_hospital_management_system
{
    partial class FormAppointment
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.dateDischargeInfobox = new experimental_hospital_management_system.gui.components.InformationDateTimePicker();
            this.dateAdmissionInfobox = new experimental_hospital_management_system.gui.components.InformationDateTimePicker();
            this.statusInfobox = new experimental_hospital_management_system.gui.components.InformationCheckBox();
            this.roomButtonbox = new experimental_hospital_management_system.gui.components.InformationButtonbox();
            this.patientButtonbox = new experimental_hospital_management_system.gui.components.InformationButtonbox();
